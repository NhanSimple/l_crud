...
<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="/students/destroy/{{ $student->id }}" enctype="multipart/form-data">
            @csrf
            @method('Post')
            <div class="row mb-3">
            ...
            <div class="text-center">
               ...
               <button class="btn btn-primary"> <a href="/students/index" style="color: aliceblue">back to home</a></button>
            </div>
        </form>
    </div>
</div>
